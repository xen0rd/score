			...
			<div class="row">
				<div class="col-md-6">		
					<div class="form-group">
						<label for="first_name" class="label label-danger">First name</label>
						<input type="text" id="first_name" class="form-control" value="<?=$userInfo->first_name?>" disabled>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label for="last_name" class="label label-danger">Last name</label>
						<input type="text" id="last_name" class="form-control" value="<?=$userInfo->last_name?>" disabled>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label for="date_of_birth" class="label label-danger">Date of birth</label>
						<div class="input-group date">
						    <input type="text" id="date_of_birth" class="form-control" value="<?=$userInfo->date_of_birth?>" disabled>
			...
			<div class="row">
				<div class="col-md-6">	
					<div class="form-group">
						...
						<input type="text" name="current_address" id="current_address" class="form-control" value="<?=$userInfo->current_address?>">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="permanent_address" id="permanent_address" class="form-control" value="<?=$userInfo->permanent_address?>">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="state" id="state" class="form-control" value="<?=$userInfo->state?>">
						<?=form_error('state');?>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="postal_code" id="postal_code" class="form-control" value="<?=$userInfo->postal_code?>">
...
<script>
	$(function(){
		...
		$("#country_code option").filter(function() {
		    return $(this).text() == "<?=$userInfo->country_name?>"; 
		}).attr('selected', true);
